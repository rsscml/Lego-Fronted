...
var AuthenticationService = /** @class */ (function () {
    ...
    AuthenticationService.prototype.login = function (data) {
        return this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].baseUrl + "/login", data);
    };
    AuthenticationService.prototype.forgot = function (email) {
        return this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].baseUrl + "/admin_panel/api/otp_send_email", { email: email });
    };
    AuthenticationService.prototype.verify = function (data) {
        return this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].baseUrl + "/admin_panel/api/forgotpass_otp_verify_email", data);
    };
    AuthenticationService.prototype.reset = function (data) {
        return this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].baseUrl + "resetPassword", data);
    };
    AuthenticationService.prototype.changePassword = function (data) {
        return this.http.post(src_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].baseUrl + "/admin_panel/api/forgotpass_reset", data);
    };
...
//# sourceMappingURL=default~layout-layout-module~shared-shared-module.js.map